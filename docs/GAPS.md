...
9. **Read the ACT-R paper.** It turns out to be gold open access (CC-BY) at the ACM DOI, just blocked to automated fetching. Download it manually and verify its implementation specifics before locking the formulation.
