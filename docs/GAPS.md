...
2. **Formulation.** Hou et al.'s single formula vs ACT-R activation vs MemoryBank's Ebbinghaus. Hou is the paper we set out to improve. ACT-R brings native spreading activation and human-fitted parameters. Likely hybrid: Hou-style per-node dynamics with ACT-R-style spreading along edges.
